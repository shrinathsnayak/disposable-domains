...
export const BLOCKED_SOURCES: Source[] = [
  {
  ...
  {
    name: "andreis/disposable-email-domains",
    url: "https://raw.githubusercontent.com/andreis/disposable-email-domains/master/domains.txt",
    format: "lines",
  },
  {
    name: "TheDahoom/disposable-email",
    url: "https://raw.githubusercontent.com/TheDahoom/disposable-email/main/blacklist.txt",
    format: "lines",
  },
  {
    name: "eser/sanitizer-svc",
    url: "https://raw.githubusercontent.com/eser/sanitizer-svc/main/disposable_email_blocklist.conf",
    format: "lines",
  },
  {
    name: "kslr/disposable-email-domains",
    url: "https://raw.githubusercontent.com/kslr/disposable-email-domains/master/list.txt",
    format: "lines",
  },
  {
    name: "sublime-security/static-files",
